...
- Bumped the app version to `4.2.6` and the service worker cache to `calorietrack-shell-v32`.
...
- Food logs, history, targets, settings, weight entries, meal plans, Nutrition Intelligence, and backups remain local.
